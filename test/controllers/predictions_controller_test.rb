...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { mainscore1: @prediction.mainscore1, mainscore2: @prediction.mainscore2, match_id: @prediction.match_id, user_id: @prediction.user_id }
    end
  ...
  test "should update prediction" do
    patch :update, id: @prediction, prediction: { mainscore1: @prediction.mainscore1, mainscore2: @prediction.mainscore2, match_id: @prediction.match_id, user_id: @prediction.user_id }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
